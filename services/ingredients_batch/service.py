"""Scheduled batch ingestion for ingredients."""
...
CONFIG_PATH = ROOT / "config" / "ingredients.yaml"
...
def main() -> None:
    ...
    try:
        ...
        neo4j.close()
        LOG.info("ingredients_batch completed")
        ...
        append_run_summary("ingredients", summary, ROOT)
